...
def videoOverlay(request):
    ...
    yesLegendTextContAddClass = ''
    noLegendTextContAddClass = ''
    if yes_count > 9:
        yesLegendTextContAddClass = 'yesDoubleDigit'
    if no_count > 9:
        noLegendTextContAddClass = 'noDoubleDigit'
    overlay_display_data.update({'yes_count':yes_count, 'no_count':no_count, 'yesLegendTextContAddClass':yesLegendTextContAddClass, 'noLegendTextContAddClass':noLegendTextContAddClass})
